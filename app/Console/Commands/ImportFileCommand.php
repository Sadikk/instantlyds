        ...
        try {
            ...
            foreach ($csv as $record) {
                ...
                DB::table('contacts')->insert([
                    ...
                    'job_company_name' =>  preg_replace("/[^A-Za-z0-9 ]/", '', substr($record['job_company_name'], 0, 250)),
                    'job_company_website' => substr($record['job_company_website'], 0, 250),
                    ...
                    'phone_numbers' => preg_replace("/[^A-Za-z0-9 ]/", '', substr($record['phone_numbers'], 0, 250)),
